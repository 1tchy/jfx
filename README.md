...
- Then building dylib file with `./gradlew build -PCOMPILE_WEBKIT=true -PCOMPILE_MEDIA=true -xtest` (might run for 1.5 hours)
...
- Adding it to Dropbox as a "poor mans release": https://www.dropbox.com/scl/fi/o73yt0fak5we0lcxf8tn5/libjfxwebkit.dylib?rlkey=wa4mzvwzc0mdeyy9w79q0cgse&dl=1
